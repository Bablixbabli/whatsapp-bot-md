...
module.exports = {
  ...
  BRANCH: 'master',
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || '❤️,BABLI',
  ALWAYS_ONLINE: toBool(process.env.ALWAYS_ONLINE),
  LOG_MSG: toBool(process.env.LOG_MSG) || true,
  RMBG_KEY: process.env.RMBG_KEY || 'neLbXXrp8bSDcohnp1CW5UEa',
  BAILEYS_LOG_LVL: process.env.BAILEYS_LOG_LVL || 'silent',
  LANG: (process.env.LANGUAG || 'en').toLowerCase(),
  WARN_LIMIT: process.env.WARN_LIMIT || 10,
  ...
  KOYEB_NAME: (process.env.KOYEB_NAME || 'saeed').trim(),
  KOYEB_API: (process.env.KOYEB_API || 'fmi76346nygyeyrslrnfgtt5as2xx9wykol0nh8muv079yai6qsfeupe8gmx3ie6').trim(),
